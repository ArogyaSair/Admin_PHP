...
session_start();
    ...
    if(isset($_POST['btnSubmit'])){
        ...
        header("location:StateAddView.php");
    }
    if(isset($_REQUEST['id'])){
        $id=$_REQUEST['id'];
        $url="ArogyaSair/tblStates/$id";
...
<form Method="POST" enctype="multipart/form-data">
    <div class="card">
        ...
        <div class="border-top">
            <div class="card-body">
                <input type="submit" class="btn btn-primary" name="btnSubmit" value="Add State">
            </div>
        </div>
    </div>
</form>
                    ...
                    <table id="zero_config" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?=$row['StateName'];?></td>
                                <td>
                                    <a class="delete" href="StateAddView.php?id=<?php echo $key?>"
                                        onclick="return confirm('Are you sure you want to delete <?=$row['StateName'];?> state ?');"><i
